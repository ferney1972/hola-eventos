...
export default function Home() {
  ...
  const featuredProductIds = [
    ...
    "silla-tiffany-vintage",
    "silla-tiffany-dorada",
    "silla-tiffany-plata",
  ...
  const categoryById: Record<string, string> = {
    ...
    "silla-tiffany-vintage": "sillas",
    "silla-tiffany-dorada": "sillas",
    "silla-tiffany-plata": "sillas",
    "silla-tiffany-transparente": "sillas",
    "silla-tiffany-negra": "sillas",
    // Butacas y diseño
