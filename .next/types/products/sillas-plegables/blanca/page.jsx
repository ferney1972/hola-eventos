...
export default function SillaPlegableBlanca() {
  ...
  const añadirAlCarrito = () => {
    alert(`✅ ${cantidad} x Silla plegable blanca añadido a la solicitud`);
  };
    ...
    <main className="min-h-screen bg-white">
      <section className="mx-auto max-w-5xl px-4 py-10">
        <h1 className="mb-4 text-center text-3xl font-extrabold text-blue-900">
          Silla Plegable Blanca
        </h1>
        <p className="mx-auto mb-10 max-w-3xl text-center text-sm text-gray-600">
          Silla plegable blanca, ligera y resistente, ideal para eventos donde
          necesitas muchos asientos con una estética limpia y neutra.
        </p>
          ...
          <div>
            <ul className="space-y-5 text-sm text-gray-700">
              <li>
                ...
                <p>Estructura metálica con asiento y respaldo en plástico blanco.</p>
              </li>
              <li>
                <p className="font-semibold text-blue-600">Uso</p>
                <p>Perfecta para comuniones, bautizos, reuniones y eventos al aire libre.</p>
              </li>
              <li>
                <p className="font-semibold text-blue-600">Características</p>
                <p>Plegable, apilable y fácil de transportar y almacenar.</p>
              </li>
            </ul>
